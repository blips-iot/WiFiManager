...
const char HTTP_FORM_END[]         PROGMEM = "<br/><br/><button type='submit'>Salar</button></form>";
...
const char HTTP_SAVED[]            PROGMEM = "<div class='msg'>Salvando credenciais e<br/> tentando conectar a rede...<br />Em caso de falha, tente novamente.</div>";
...
"button,input[type='button'],input[type='submit']{cursor:pointer;border:0;background-color:#FBBB00;color:#fff;line-height:2.4rem;font-size:1.2rem;width:100%}"
"input[type='file']{border:1px solid #FBBB00}"
".wrap {text-align:left;display:inline-block;min-width:260px;max-width:500px}"
// links
"a{color:#000;font-weight:700;text-decoration:none}a:hover{color:#FBBB00;text-decoration:underline}"
// quality icons
...
// msg callouts
".msg{padding:20px;margin:20px 0;border:1px solid #eee;border-left-width:5px;border-left-color:#777}.msg h4{margin-top:0;margin-bottom:5px}.msg.P{border-left-color:#FBBB00}.msg.P h4{color:#FBBB00}.msg.D{border-left-color:#dc3630}.msg.D h4{color:#dc3630}.msg.S{border-left-color: #5cb85c}.msg.S h4{color: #5cb85c}"
// lists
...
const char HTTP_INFO_aboutver[]     PROGMEM = "<dt>Sobre</dt><dd>{1}</dd>";
...
const char S_brand[]              PROGMEM = "Blips Admin";
...
const char S_titlewifi[]          PROGMEM = "Configurar IOT";
...
const char S_nonetworks[]         PROGMEM = "Nenhuma rede encontrada. Atualize para buscar novamente.";
...
#ifdef ESP8266
    const char S_ssidpre[]        PROGMEM = "blips";
#elif defined(ESP32)
